...
class Field {
    ...
    void update_host() {
      // ...
      auto success = cudaMemcpy(host_ptr_, device_ptr_, xdim_*ydim_*sizeof(double), cudaMemcpyDeviceToHost);
      
    }

    void update_device() {
      // ...
      auto success = cudaMemcpy(device_ptr_, host_ptr_, xdim_*ydim_*sizeof(double), cudaMemcpyHostToDevice);
